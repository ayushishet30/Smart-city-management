...
-- Show Employee-Vehicle assignments
SELECT * FROM Employee_Vehicle;

-- Show Resident-Bin assignments
SELECT * FROM Resident_Bin;

-- Show Collection-Recycling assignments
SELECT * FROM Collection_Recycling;

-- Show Vendor-WasteType assignments
SELECT * FROM Vendor_WasteType;
...
SELECT * FROM Vehicle_Waste_Summary;
...
SELECT * FROM Plant_Processed_Waste;
...
SELECT ResidentName, CollectionMonth, WastePerMonth,
